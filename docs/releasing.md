...
verifies that their data and schedule survive. The cold-upgrade test uses separate Python processes. The warm-upgrade test
...
runtime. Migrations must not import sibling extension modules.
...
health after restarting. The tests do not claim that live route or scheduler
...
blocked before m006 finishes. Already migrated databases do not rerun these steps. Containers use FakeWallet and have
