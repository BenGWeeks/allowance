...
def test_end_datetime():
    ...
    with httpx.Client(base_url=BASE_URL, timeout=30.0) as client:
        ...
        try:
            login_response = client.post('/api/v1/auth', json={'username': USERNAME, 'password': PASSWORD})
        ...
        create_response = client.post('/allowance/api/v1/allowance', json=test_data, headers=headers)
        ...
        get_response = client.get(f'/allowance/api/v1/allowance/{allowance_id}', headers=headers)
        ...
        delete_response = client.delete(f'/allowance/api/v1/allowance/{allowance_id}', headers=headers)
