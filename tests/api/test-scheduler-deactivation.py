    ...
    try:
        ...
        async with httpx.AsyncClient() as client:
            ...
            for minute in range(3):
                await asyncio.sleep(60 if minute > 0 else 0)  # Wait 1 minute between checks
                ...
                if response.status_code == 200:
                    ...
                    for a in allowances:
                        if a['id'] == test_id:
                            ...
                            print(f"   Minute {minute + 1}: Active={is_active}, "
            ...
            if all_inactive:
                print(f"✅ Allowance stayed inactive for all {len(deactivation_checks)} checks")
            else:
                active_checks = [c for c in deactivation_checks if c['active']]
                print(f"❌ BUG DETECTED: Allowance was active in {len(active_checks)} checks after expiry!")
            ...
            if datetimes_preserved:
                ...
                missing_checks = [c for c in deactivation_checks
